...
function pop_Blitz20182_8(feature, layer) {
    ...
    var popupContent = '<table>\
            ...
            <tr>\
                <td colspan="2"> UFC coliformes: ' + (feature.properties['PROMEDIO'] !== null ? autolinker.link(feature.properties['PROMEDIO'].toLocaleString()) : '') + '</td>\
            </tr>\
            <tr>\
...
map.on("zoomend", function(e) {
    ...
    title.update = function () {
        this._div.innerHTML = '<b> Concesiones, monitoreos y acciones por el agua en las cuencas Actopan y La Antigua</b>';
    };
    title.addTo(map);
var baseMaps = {};
var overlaysTree = [
    {label: '<img width="3px" src="/themes/custom/asamblea/mapa_guardianxs/legend/Hidrologacentrover_14.png" /> Hidrología centro Veracruz', layer: layer_Hidrologacentrover_14},
    {label: '<img width="5px" src="/themes/custom/asamblea/mapa_guardianxs/legend/CuencascentroVeracruzcuencascentrovershp_13.png" /> Cuencas centro Veracruz', layer: layer_CuencascentroVeracruzcuencascentrovershp_13},
 //   {label: '<img src="/web/sitio/web/themes/custom/asamblea/mapa_guardianxs/legend/CuencascentroVeracruzcuencascentrovershp_13.png" /> Cuencas centro Veracruz', layer: layer_CuencascentroVeracruzcuencascentrovershp_13},
    {label: '<img width="5px" src="/themes/custom/asamblea/mapa_guardianxs/legend/mpioszonacentralver_12.png" /> Municipios zona central Veracruz', layer: layer_mpioszonacentralver_12},
    {label: 'REPDA 2021 Concesiones región Xalapa<br /><table><tr><td style="text-align: center;"><img src="/themes/custom/asamblea/mapa_guardianxs/legend/REPDA20213Concesiones12mpiosregionxalapa_11_DESCARGA1.png" /></td><td>DESCARGA</td></tr><tr><td style="text-align: center;"><img src="/themes/custom/asamblea/mapa_guardianxs/legend/REPDA20213Concesiones12mpiosregionxalapa_11_SUBTERRANEO2.png" /></td><td>SUBTERRANEO</td></tr><tr><td style="text-align: center;"><img src="/themes/custom/asamblea/mapa_guardianxs/legend/REPDA20213Concesiones12mpiosregionxalapa_11_SUPERFICIAL3.png" /></td><td>SUPERFICIAL</td></tr><tr><td style="text-align: center;"><img src="/themes/custom/asamblea/mapa_guardianxs/legend/REPDA20213Concesiones12mpiosregionxalapa_11_ZONAFEDERAL4.png" /></td><td>ZONA FEDERAL</td></tr></table>', layer: layer_REPDA20213Concesiones12mpiosregionxalapa_11},
...
//    {label: '<img src="/web/themes/custom/asamblea/mapa_guardianxs/legend/BlitzMuestreo2010_10.png" /> Blitz Muestreo 2010', layer: layer_BlitzMuestreo2010_10},
    {label: '<img width="4px" src="/themes/custom/asamblea/mapa_guardianxs/legend/BlitzMuestreo2010_10.png" /> Blitz Muestreo 2010', layer: layer_BlitzMuestreo2010_10},
    {label: '<img width="5px" src="/themes/custom/asamblea/mapa_guardianxs/legend/BlitzMuestreo2018_9.png" /> Blitz Muestreo 2018', layer: layer_BlitzMuestreo2018_9},
    {label: '<img width="5px" src="/themes/custom/asamblea/mapa_guardianxs/legend/Blitz20182_8.png" /> Blitz 2018-2', layer: layer_Blitz20182_8},
    {label: '<img width="5px" src="/themes/custom/asamblea/mapa_guardianxs/legend/BlitzNaolinco20072021_7.png" /> Blitz Naolinco 2007-2021', layer: layer_BlitzNaolinco20072021_7},]},
{label: '<b>Acciones por el agua</b>', selectAllCheckbox: true, children: [
    {label: '<img width="5px" src="/themes/custom/asamblea/mapa_guardianxs/legend/IniciativaAguapasapormiCasa_6.png" /> Iniciativa Agua pasa por mi Casa', layer: layer_IniciativaAguapasapormiCasa_6},
